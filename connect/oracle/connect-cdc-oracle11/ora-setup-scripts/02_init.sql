...
-- amith comment for EE
CREATE USER MYUSER1 IDENTIFIED BY testpwduser1 ;
ALTER USER MYUSER1 QUOTA UNLIMITED ON USERS;

CREATE USER MYUSER2 IDENTIFIED BY  testpwduser2 ;
ALTER USER MYUSER2 QUOTA UNLIMITED ON USERS;

-- amith comment for XE
--CREATE USER MYUSER1 IDENTIFIED BY testpwduser1 tablespace USERS;

-- only required to execute DBMS_LOCK.SLEEP (not required by connector)
GRANT EXECUTE ON DBMS_LOCK TO CDC_PRIVS;

GRANT CDC_PRIVS to MYUSER1;
GRANT CDC_PRIVS to MYUSER2;

-- Enable Supplemental Logging for All Columns
ALTER DATABASE ADD SUPPLEMENTAL LOG DATA;
ALTER DATABASE ADD SUPPLEMENTAL LOG DATA (ALL) COLUMNS;

GRANT FLASHBACK ANY TABLE TO MYUSER1;
GRANT FLASHBACK ANY TABLE TO MYUSER2;
